...
--
-- Host: localhost
-- Creato il: Mag 07, 2020 alle 15:30
...
--
ALTER TABLE `accettatore`
  MODIFY `id_accettatore` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT per la tabella `allegati_c`
--
ALTER TABLE `allegati_c`
  MODIFY `id_all` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4184;
--
...
--
ALTER TABLE `allegato`
  MODIFY `id_all` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT per la tabella `appuntamenti`
--
ALTER TABLE `appuntamenti`
  MODIFY `id_app` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6254;
--
-- AUTO_INCREMENT per la tabella `commesse`
--
ALTER TABLE `commesse`
  MODIFY `id_com` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6941;
--
-- AUTO_INCREMENT per la tabella `gestore`
--
ALTER TABLE `gestore`
  MODIFY `id_gest` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT per la tabella `preventivi`
--
ALTER TABLE `preventivi`
  MODIFY `id_preventivo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=255;
--
...
--
ALTER TABLE `stato_prenotazione`
  MODIFY `id_sta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT per la tabella `tecnico`
--
ALTER TABLE `tecnico`
  MODIFY `id_tec` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
-- AUTO_INCREMENT per la tabella `tipo_lavorazione`
--
ALTER TABLE `tipo_lavorazione`
  MODIFY `id_lav` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT per la tabella `tipo_pagamento`
--
ALTER TABLE `tipo_pagamento`
  MODIFY `id_pag` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
