...
function Header()
{
	...
	$this->Cell(282,5,'Via Pinco Palla, 15',0,1,'C');
	$this->Ln(3);
	$this->Cell(302,5,'CAP - Citta (PR)',0,1,'C');
	$this->Ln(3);
	$this->Cell(279,5,'Tel/Fax 02002365210',0,1,'C');
	$this->Ln(3);
	$this->Cell(298,5,'http://www.azienda.com',0,0,'C');
    // Line break
    $this->Ln(20);
}
...
function Footer()
{
    ...
    // Page number
    $this->Cell(0,10,'Ringraziamo per la preferenza accordata',0,0,'C');
}
}
*/
