...
$sql2 = "UPDATE appuntamenti SET veicolo = '$veicolo', data = STR_TO_DATE('$data', '%d/%m/%Y'), ora = '$ora', cliente = '$cliente', tlav = '$tlav', telefono = '$telefono', gestore = '$gestore', tipo_pren = '$tipo_pren', tipo_lavorazione = '$tipo_lavorazione', stato_pren = '$stato_pren', note = '$note', email = '$email' WHERE id_app = '$id_app'";
