...
<div class="clear"></div>
		...
		<div class="row"><!--APRO LA PRIMA RIGA-->
            <div class="col-sm-3">
				<div class="card-home">
				<div class="card-header-home"><b>ALD WEB-RELIEF</b></div>
					<div class="card-block-home">
						<a href="#" target="_blank"><img width="150" height="150" src="icon/ald.jpg" class="img-responsive"><br/></a>   
					</div>
			...
			<div class="col-sm-3">
				<div class="card-home">
				<div class="card-header-home"><b>ALD WEB-SUPPLIER</b></div>
					<div class="card-block-home">
						 <a href="#" target="_blank"><img width="150" height="150" src="icon/ald.jpg" class="img-responsive"><br/></a> 
					</div>
					<div class="card-header">
			...
			<div class="col-sm-3">
				...
				<div class="card-header-home"><b>LEASEPLAN - STOP & GO</b></div>
					<div class="card-block-home">
						<a class="thumbnail" href="#" target="_blank"><img width="150" height="150" src="icon/leaseplan.png" class="img-responsive"><br/></a>   
					</div>
					<div class="card-header">
					<b>User: </b>Utente<br>
					<b>Pass: </b>Password
			...
			<div class="col-sm-3">
				<div class="card-home">
				<div class="card-header-home"><b>LEASYS</b></div>
					<div class="card-block-home">
						 <a class="thumbnail" href="#" target="_blank"><img width="150" height="150" src="icon/leasys.jpg" class="img-responsive"><br/></a>  
					</div>
					<div class="card-header">
					<b>User: </b>Utente<br>
					<b>Pass: </b>Password
		...
		<div class="row"><!--APRO LA SECONDA RIGA-->
			...
			<div class="col-sm-3">
				...
				<div class="card-header-home"><b>SAOL</b></div>
					<div class="card-block-home">
						 <a href="#" target="_blank"><img width="150" height="150"src="icon/saol.png" class="img-responsive"><br/></a>  
					</div>
					<div class="card-header">
					<b>User: </b>Utente<br>
					<b>Pass: </b>Password
			...
			<div class="col-sm-3">
				...
				<div class="card-header-home"><b>GE.CO MAGNETI MARELLI</b></div>
					<div class="card-block-home">
						 <a href="#" target="_blank"><img width="150" height="150"src="icon/magnetimarelli.jpg" class="img-responsive"><br/></a>
					</div>
					<div class="card-header">
					<b>User: </b>Utente<br>
					<b>Pass: </b>Password
			...
			<div class="col-sm-3">
				<div class="card-home">
				<div class="card-header-home"><b>E-COMMERCE</b></div>
					<div class="card-block-home">
						 <a href="# target="_blank"><img width="150" height="150"src="icon/grdistrib.png" class="img-responsive"><br/></a> 
					</div>
					<div class="card-header">
					<b>User: </b>Utente<br>
					<b>Pass: </b>Password
			...
			<div class="col-sm-3">
				<div class="card-home">
				<div class="card-header-home"><b>LINK-ENTRY</b></div>
					<div class="card-block-home">
						 <a href="#" target="_blank"><img width="150" height="150"src="icon/logo_fca.jpg" class="img-responsive"><br/></a> 
					</div>
					<div class="card-header">
					<b>User: </b>Utente<br>
					<b>Pass: </b>Password
		...
		<div class="row"><!--APRO LA TERZA RIGA-->
			...
			<div class="col-sm-3">
				...
				<div class="card-header-home"><b>CAR SERVER</b></div>
					<div class="card-block-home">
						 <a href="#" target="_blank"><img width="150" height="150" src="icon/carserver.svg" class="img-responsive"><br/></a>  
					</div>
					<div class="card-header">
					<b>User: </b>Utente<br>
					<b>Pass: </b>Password
			...
			<div class="col-sm-3">
				<div class="card-home">
				<div class="card-header-home"><b>MR FLEET</b></div>
					<div class="card-block-home">
						 <a href="#" target="_blank"><img width="150" height="150" src="icon/mrfleet.png" class="img-responsive"><br/></a>  
					</div>
					<div class="card-header">
					<b>User: </b>Utente<br>
					<b>Pass: </b>Password
			...
			<div class="col-sm-3">
				...
				<div class="card-header-home"><b>SIFA'</b></div>
					<div class="card-block-home">
						 <a href="#" target="_blank"><img width="150" height="150" src="icon/sifa.png" class="img-responsive"><br/></a>  
					</div>
					<div class="card-header">
					<b>User: </b>Utente<br>
					<b>Pass: </b>Password
			...
			<div class="row"><!--APRO LA QUARTA RIGA-->	

			<div class="col-sm-3">
				<div class="card-home">
				<div class="card-header-home"><b>GENERALI</b></div>
					<div class="card-block-home">
						 <a href="#" target="_blank"><img width="150" height="150" src="icon/generali.png" class="img-responsive"><br/></a>  
					</div>
					<div class="card-header">
					<b>User: </b>Utente<br>
					<b>Pass: </b>Password
