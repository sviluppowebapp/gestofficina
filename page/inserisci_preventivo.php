...
<form class="form" method="post" id="modulo" action="index.php?page=salva_preventivo" enctype="multipart/form-data">
	...
	<div class="row">
		<div class="col-md-4">
			  <div class="input-group mb-2 mr-sm-2 mb-sm-0">
				...
				<input type="text" class="form-control" id="datepicker" placeholder="Data Preventivo" name="data" required="required" autocomplete="off">
			  </div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-4">
			  <div class="input-group">
				...
				<input type="text" class="form-control" aria-hidden="true" name="cliente" required="required" placeholder="Nome Cognome Cliente">
			  </div>
		</div>
		...
		<div class="col-md-4">
			  <div class="input-group">
				...
				<input type="text" class="form-control" name="tel" required="required" placeholder="Telefono">
			  </div>
		</div>	
	</div> 
		...
		<div class="col-md-4">
		 <label class="sr-only" for="Veicolo">Veicolo</label>
			  <div class="input-group mb-2 mr-sm-2 mb-sm-0">
				...
				<input type="text" class="form-control" name="veicolo" required="required" placeholder="Veicolo" >
			  </div>
		</div>
		...
		<div class="col-md-4">
		 <label class="sr-only" for="Targa">Targa</label>
			  <div class="input-group mb-2 mr-sm-2 mb-sm-0">
				...
				<input type="text" class="form-control" name="targa" required="required" placeholder="Targa Veicolo" id=targa" maxlength="8" onkeyup="VerificaTarga(this)">
			  </div>
		</div>
		...
		<div class="col-md-4">
		 <label class="sr-only" for="Km">Km al preventivo</label>
			  <div class="input-group mb-2 mr-sm-2 mb-sm-0">
				...
				<input type="text" class="form-control" name="km" required="required" placeholder= "Km al preventivo" id="km" onkeyup="VerificaKm(this)">
			  </div>
		</div>	
	</div>
...
<div class="row">
		...
		<div class="col-md-3">
				 ...
				 <div class="input-group mb-2 mr-sm-2 mb-sm-0">
					<span class="input-group-addon"><i class="fa fa-users" aria-hidden="true"></i></span>
						<select class="form-control" id="n_accettatore" name="n_accettatore" required="required">
						<?php 
		...
		<div class="col-md-3">
				 ...
				 <div class="input-group mb-2 mr-sm-2 mb-sm-0">
					<span class="input-group-addon"><i class="fa fa-users" aria-hidden="true"></i></span>
						<select class="form-control" id="n_tecnico" name="n_tecnico">
						<?php 
...
<div class="card-commesse">
  ...
  <div class="card-block">
	...
	<div class="text-right">
		<button type="button" class="btn btn-success right" onclick="if( confirm('Confermi registrazione preventivo ?') ){this.form.submit();}">Registra Preventivo</button>  
	</div>
