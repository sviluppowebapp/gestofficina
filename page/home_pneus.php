...
<div class="clear"></div>
		...
		<div class="row">
			...
			<div class="col-sm-3">
				<div class="card-home">
				<div class="card-header-home"><b>FLOTTE AMICHE</b></div>
					<div class="card-block-home">
						 <a class="thumbnail" href="#" target="_blank"><img width="150" height="150" src="icon/michelin-man.png" class="img-responsive"><br/></a>  
					</div>
            ...
            <div class="col-sm-3">
				<div class="card-home">
				<div class="card-header-home"><b>FORNITORE 1</b></div>
					<div class="card-block-home">
						<a href="#" target="_blank"><img width="150" height="150" src="icon/michelin-man.png" class="img-responsive"><br/></a>   
					</div>
					<div class="card-header">
					<b>User: </b>Utente<br>
					<b>Pass: </b>Password
			...
			<div class="col-sm-3">
				<div class="card-home">
				<div class="card-header-home"><b>FORNITORE 2</b></div>
					<div class="card-block-home">
						<a class="thumbnail" href="#" target="_blank"><img width="150" height="150" src="icon/michelin-man.png" class="img-responsive"><br/></a>   
					</div>
					<div class="card-header">
			...
			<div class="col-sm-3">
				<div class="card-home">
				<div class="card-header-home"><b>FORNITORE 3</b></div>
					<div class="card-block-home">
						 <a href="#" target="_blank"><img width="150" height="150" src="icon/michelin-man.png" class="img-responsive"><br/></a>  
					</div>
					<div class="card-header">
		...
		<div class="row">
			...
			<div class="col-sm-3">
				<div class="card-home">
				<div class="card-header-home"><b>FORNITORE 4</b></div>
					<div class="card-block-home">
						 <a href="#" target="_blank"><img width="150" height="150"src="icon/michelin-man.png" class="img-responsive"><br/></a>  
					</div>
					<div class="card-header">
			...
			<div class="col-sm-3">
				<div class="card-home">
				<div class="card-header-home"><b>FORNITORE 5</b></div>
					<div class="card-block-home">
						 <a href="#" target="_blank"><img width="150" height="150"src="icon/michelin-man.png" class="img-responsive"><br/></a>  
					</div>
					<div class="card-header">
			...
			<div class="col-sm-3">
				<div class="card-home">
				<div class="card-header-home"><b>FORNITORE 6</b></div>
					<div class="card-block-home">
						 <a href="http://web.maxtyre.it/" target="_blank"><img width="150" height="150"src="icon/maxtyre.jpg" class="img-responsive"><br/></a>  
					</div>
					<div class="card-header">
					<b>User: </b>Utente<br>
					<b>Pass: </b>Password
