...
<div class="clear"></div>
      ...
      <div class="col-sm-3">
				...
				<div class="card-header-home"><b>Quotatore Leaseplan</b></div>
					<div class="card-block-home">
						<a href="#" target="_black"><img src="icon/leaseplan.png" class="img-fluid"><br/></a>   
					</div>
			...
			<div class="col-sm-3">
				...
				<div class="card-header-home"><b>Quotatore Ald</b></div>
					<div class="card-block-home">
						 <a class="thumbnail" href="#" target="_black"><img src="icon/ald.jpg" class="img-fluid"><br/></a>  
					</div>
					<div class="card-header">
					<b>User: </b>Utente<br>
					<b>Pass: </b>Password
			...
			<div class="col-sm-3">
				...
				<div class="card-header-home"><b>Quotatore Leasys</b></div>
					<div class="card-block-home">
						 <a class="thumbnail" href="#" target="_black"><img src="icon/leasys_nol.png" class="img-fluid"><br/></a>  
					</div>
					<div class="card-header">
					<b>User: </b>Utente<br>
					<b>Pass: </b>Password
