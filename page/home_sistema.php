...
<div class="clear"></div>
		...
		<div class="row">
			...
			<div class="col-sm-3">
				<div class="card-home">
				<div class="card-header-home"><b>Mod. Nome Tecnico</b></div>
					<div class="card-block-home">
						<a class="thumbnail" href="index.php?page=tecnici"><img src="icon/gestione_tecnico_55.png"><br/></a>       
					</div>
				</div>
			</div>
			...
			<div class="col-sm-3">
				...
				<div class="card-header-home"><b>Registra Promemoria</b></div>
					<div class="card-block-home">
						<a class="thumbnail" href="#" target="_blank"><img src="icon/promemoria_55.png"><br/></a>        
					</div>
				</div>
			</div>
			...
			<div class="col-sm-3">
				<div class="card-home">
				<div class="card-header-home"><b>Esporta Database</b></div>
					<div class="card-block-home">
						<a class="thumbnail" href="#" target="_blanck"><img src="icon/salva_database_55.png"><br/></a>      
					</div>
				</div>
			</div>	
