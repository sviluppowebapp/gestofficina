...
<div class="clear"></div>
		...
		<div class="row">
            <div class="col-sm-3">
				...
				<div class="card-header-home"><b>OCTOTELEMATICS</b></div>
					<div class="card-block-home">
						<a href="#" target="_blank"><img width = "150" src="icon/assicurazioni/octo.jpg" class="img-responsive"><br/></a>   
					</div>
			...
			<div class="col-sm-3">
				...
				<div class="card-header-home"><b>VIASAT</b></div>
					<div class="card-block-home">
						 <a href="#" target="_blank"><img width="170" src="icon/assicurazioni/viasat.jpg" class="img-responsive"><br/></a>  
					</div>
					<div class="card-header">
					<b>User: </b>Utente<br>
					<b>Pass: </b>Password
			...
			<div class="col-sm-3">
				...
				<div class="card-header-home"><b>ALLIANZ</b></div>
					<div class="card-block-home">
						 <a href="#" target="_blank"><img width="100" src="icon/assicurazioni/allianz.png" class="img-responsive"><br/></a>  
					</div>
					<div class="card-header">
					<b>User: </b>Utente<br>
					<b>Pass: </b>Password
			...
			<div class="col-sm-3">
				...
				<div class="card-header-home"><b>VODAFONE</b></div>
					<div class="card-block-home">
						 <a class="thumbnail" href="#" target="_blank"><img width="160" src="icon/assicurazioni/vodafone.jpg" class="img-responsive"><br/></a>
					</div>
					<div class="card-header">
					<b>User: </b>Utente<br>
					<b>Pass: </b>Password					
		...
		<div class="row"><!--APRO LA SECONDA RIGA-->
		    ...
		    <div class="col-sm-3">
				...
				<div class="card-header-home"><b>DIMISA</b></div>
					<div class="card-block-home">
						<a class="thumbnail" href="#" target="_blank"><img width="160" src="icon/assicurazioni/dms.png" class="img-responsive"><br/></a>   
					</div>
					<div class="card-header">
					<b>User: </b>Utente<br>
					<b>Pass: </b>Password
		    ...
		    <div class="col-sm-3">
				...
				<div class="card-header-home"><b>ALFAEVOLUTION</b></div>
					<div class="card-block-home">
						<a class="thumbnail" href="#" target="_blank"><img width="160" src="icon/assicurazioni/alfaevolution_n.png" class="img-responsive"><br/></a>   
					</div>
					<div class="card-header">
					<b>User: </b>Utente<br>
					<b>Pass: </b>Password
		    ...
		    <div class="col-sm-3">
				...
				<div class="card-header-home"><b>INFOMOBILITY</b></div>
					<div class="card-block-home">
						<a class="thumbnail" href="#" target="_blank"><img width="160" src="icon/assicurazioni/infomob_n.png" class="img-responsive"><br/></a>   
					</div>
					<div class="card-header">
					<b style="color:red">User: </b>utente<br>
					<b style="color:red">Pass: </b>password
					</div>
				</div>
			</div>
		...
		<div class="col-sm-3">
				...
				<div class="card-header-home"><b>G-EVOLUTION</b></div>
					<div class="card-block-home">
						<a href="#" target="_blank"><img width = "150" src="icon/assicurazioni/gevolution.png" class="img-responsive"><br/></a>   
					</div>
					<div class="card-header">
					<b>User: </b>utente<br>
					<b>Pass: </b>password
