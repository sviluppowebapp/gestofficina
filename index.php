...
<head>
    ...
    <meta name="description" content="Gestionale - Operatività Officina">
    <meta name="author" content="Crescenzo Cuomo">
...
<body>
	...
	<div class="container white">
        ...
        <hr>
				...
				<div class="footer">
					<div class="footer-text">Nome Azienda &nbsp;|&nbsp; E-mail: info@azienda.com &nbsp;|&nbsp; P.iva 01234567880 <br />
					Gestione Officina V. 2.0.1 - Copyright &copy; <?= date('Y'); ?> - All rights reserved.
					</div>
				</div>
